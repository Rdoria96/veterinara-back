...
@SpringBootTest
class PropietarioServicesImpTest {
    ...
    @Test
    @Transactional
    void insertUpdate() throws ServicesException {
    ...
    void getAll() throws ServicesException {
        List<Map<String, Object>> lista = propietarioServices.getAll();
        assertNotNull(lista);
    ...
    @Test
    void PruebaNegativaLista() throws ServicesException{
